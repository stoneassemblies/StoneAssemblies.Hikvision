...
public class AcsEventsClientFacts
{
    public class The_ListAcsEventsAsync_Method
    {
        ...
        public async Task Lists_Acs_Events_Properly_Async()
        {
            ...
            var acsEvents = await acsEventsClient.ListAcsEventsAsync(startTime, endTime, AccessControlEventTypes.Event, EventMinorTypes.FingerprintComparePass).ToListAsync();
